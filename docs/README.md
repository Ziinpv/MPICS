...
| 6 | [MQTT IoT demo](./06_MQTT_IoT_Demo.md) | P2 broker + bridge + sim |
| 7 | [SMTP quên MK](./07_SMTP_Forgot_Password.md) | Mailpit / SMTP thật |
| 8 | [10 nghiệp vụ cơ bản](./nghiepvu/README.md) | Chi tiết từng domain |
